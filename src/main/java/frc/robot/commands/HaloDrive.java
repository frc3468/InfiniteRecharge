...
public class HaloDrive extends CommandBase {
   ...
   */
  public HaloDrive(Drivetrain subsystem, DoubleSupplier magnitudey, DoubleSupplier rotation) {
...
// Called when the command is initially scheduled.
  ...
  @Override
  public void execute() {
    robotDrive.haloDrive(Math.pow(magy.getAsDouble(), DRIVEEXPONENT), Math.pow(rot.getAsDouble(), DRIVEEXPONENT));
  }
